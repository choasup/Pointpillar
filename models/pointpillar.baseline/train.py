...
from second.data.preprocess import merge_second_batch_nopadding
from second.protos import pipeline_pb2
from builder import (box_coder_builder, input_reader_builder,
...
def train(config_path,
    ...
    dataloader = torch.utils.data.DataLoader(
        ...
        num_workers=0,
        pin_memory=False,
        collate_fn=merge_second_batch_nopadding,
